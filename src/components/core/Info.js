...
const Info = () => {
  ...
  return (
    <Div width="350px" border="1px solid black">
        ...
        {visaToggle ? (
          <Div width="100%" margin="5px 0px 0px 0px" border="1px solid black">
            <Text width="100%" border="1px solid black">
              ...
              글입니다. 호주 비자에 관한 글입니다. 호주 비자에 관한 글입니다.
              호주 비자에 관한 글입니다. 호주 비자에 관한 글입니다. 호주 비자에
              관한 글입니다.호주 비자에 관한 글입니다. 호주 비자에 관한
              글입니다. 호주 비자에 관한 글입니다. 호주 비자에 관한 글입니다.
              호주 비자에 관한 글입니다.
        ...
        {phoneToggle ? (
          <Div width="100%" margin="5px 0px 0px 0px" border="1px solid black">
            ...
            <Text width="100%" border="1px solid black">
              ...
              가능 28일 제한(가격은 오차가 생길 수 있으니 자세한건 홈페이지
              참고를 추천한다.)
            </Text>
          </Div>
        ) : null}
        ...
        {bankToggle ? (
          <Div width="100%" margin="5px 0px 0px 0px" border="1px solid black">
            ...
            <Text width="100%" border="1px solid black">
              ...
              -www.commbank.com.au <br /> -유학생들이 가장 많이 이용하는
              은행으로 지점의 네트워크가 호주 최대이기 때문에 이용이 가장
              용이하다.
