...
💡 해결방안 2가지
 <aside>
 1. 박스높이를 고정시키고 데이터의 길이가 해당 높이를 벗어나면 그 안에서 스크롤 가능하게 구현하여, 박스의 위치값을 구하고 해당위치로 이동<br/>
 2. Ref를 사용하여 해당요소로 이동
</aside>
<aside>
 1번은 위치값으로 이동시, 토글이 닫혀있을 경우와 열려있을 경우 모두 생각해야 하기 때문에 2번으로 결정했습니다. useRef, forwardRef, map함수를 이용하여 ref배열의 각 요소에 해당하는 위치로 이동하도록 구현했습니다.
 </aside>
